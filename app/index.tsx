...
import DriverBookedSchedulesScreen from "./screens/DriverBookedSchedules";
...
export type RootStackParamList = {
  ...
  DriverBookedSchedulesScreen: { userId: string };
  DriverTripsScreen: { userId: string };
};
...
const Index = () => {
  return (
    ...
    >
      ...
      <Stack.Screen
        name="DriverBookedSchedules"
        component={DriverBookedSchedulesScreen}
      />
