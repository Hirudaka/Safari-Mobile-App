    ...
    <ScrollView style={styles.container}>
      ...
      {animal ? (
        <View style={styles.content}>
          <Image source={imageMapping[animal.imageUrl]} style={styles.image} resizeMode="contain" />
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}><Text style={styles.bold}>Age: </Text>{animal.age}</Text>
            <Text style={styles.infoText}><Text style={styles.bold}>Height (pixels): </Text>{height_pixels}</Text>
            <Text style={styles.infoText}><Text style={styles.bold}>Detection Confidence: </Text>{detection_confidence.toFixed(2)}%</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  infoCard: { backgroundColor: "#ffffff", padding: 15, borderRadius: 10, marginBottom: 20, elevation: 3, shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } },
  ...
  descriptionCard: { backgroundColor: "#ffffff", padding: 15, borderRadius: 10, elevation: 3, shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } },
  description: { fontSize: 16, color: "#4e4e4e", lineHeight: 22 },
